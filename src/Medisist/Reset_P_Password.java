 ...
 * @author dev
 */
public class Reset_P_Password extends javax.swing.JFrame {

  Connection con=null;
  ResultSet rs=null;
  PreparedStatement pst=null;
  
    public Reset_P_Password() {
        initComponents();
    }
    ...
    private void btnResetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnResetActionPerformed
        ...
        try{
          ...
          String sql1="select Patient_Username,Patient_Password from patient where Patient_Username='"+txtUser.getText()+"' and Patient_Password ='"+txtPassword.getText()+"'";
          ...
          while(rs.next()){
              ...
              if(user.equals(username) && pass.equals(password)){
                  if(npass.equals(cpass)){
                      String sql="update patient SET Patient_Password ='"+txtNpassword.getText()+"' where Patient_Username ='"+txtUser.getText()+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Reset_P_Password.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Reset_P_Password().setVisible(true);
            }
        });
    }
