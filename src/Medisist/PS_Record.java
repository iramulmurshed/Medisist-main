 ...
 * @author dev
 */
public class PS_Record extends javax.swing.JFrame {
Connection con=null;
ResultSet rs=null;
PreparedStatement pst=null;
    ...
    private void Get_Data(){
        String sql="select PS_ID as 'PS ID', pname as 'Problem Title', problem, solution, comment from ps";
        try{
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, 1130, 380));

        setSize(new java.awt.Dimension(1171, 485));
        setLocationRelativeTo(null);
    ...
    try{
        ...
        String sql= "select * from ps where pname = '" + Tbl_click + "'";
           pst=con.prepareStatement(sql);
            rs=  pst.executeQuery();
            if(rs.next()){
                this.hide();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PS_Record.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
